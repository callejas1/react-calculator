...
const Welcome = () => {
  return (
    <div className="intro">
      ...
      <p>In order to keep track of your progress you will need to <Link to="/register">Sing Up</Link> for an account or <Link to="/login">Sign in</Link> if you've already done so.</p>
      <p>Have fun!</p>      
    </div>
  )
}
